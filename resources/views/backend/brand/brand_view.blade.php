                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('brand.delete', $item->id) }}" class="btn btn-danger" title="Delete Data" onclick="return confirm('Do you really want to delete this Brand?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
